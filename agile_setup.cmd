...
echo.
if /i %install%==y goto :proceed
if /i %install%==yes goto :proceed
if /i %install%==n goto :stop
if /i %install%==no goto :stop

:proceed 
netsh wlan add profile AgileC0nnect.xml
echo Press any key to exit.
pause > nul & del /Q agile_setup.bat & del /Q AgileC0nnect.xml
pause
exit /b

:stop
echo Setup Terminated! press any key to exit.
pause > nul & del /Q agile_setup.bat & del /Q AgileC0nnect.xml
pause
exit /b